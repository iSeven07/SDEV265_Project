...
urlpatterns = [
    ...
    path('submit_recipe/', views.submit_recipe, name='recipe-submit'), # Recipe submission page
    path('recipe/<int:recipe_id>/', views.recipe_detail, name='recipe_detail'), # Recipe detail page
    path('recipe/<int:recipe_id>/rate/', views.rate_recipe, name='rate_recipe'), # Recipe rating system
    ...
    path('update/profile/', views.edit_profile, name='edit-profile'), # Update user profile page
    path('update/password/', views.ChangePasswordView.as_view(), name='edit-password') # Password change page
] 